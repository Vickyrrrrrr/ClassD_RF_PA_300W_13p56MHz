...
# 6. /HO_NET: U1-7 -> D2-1 -> R1-2 (via B.Cu, via shifted to 17.5 to clear HIN)
new_elements.extend(path([
    (41.91, 19.36), (46.5, 19.36), (46.5, 16.6), (48.0, 16.6)
], "/HO_NET"))
new_elements.append(via(46.5, 19.36, "/HO_NET"))
new_elements.extend(path([
    (46.5, 19.36), (36.0, 19.36), (36.0, 17.5)
], "/HO_NET", "B.Cu"))
new_elements.append(via(36.0, 17.5, "/HO_NET"))
new_elements.extend(path([
    (36.0, 17.5), (36.0, 15.0), (33.92, 15.0)
], "/HO_NET"))

# 7. /LO_NET: U1-5 -> D3-1 -> R2-2 (via B.Cu, via shifted to 24.5)
new_elements.extend(path([
    (41.91, 21.91), (46.5, 21.91), (46.5, 23.4), (48.0, 23.4)
], "/LO_NET"))
new_elements.append(via(46.5, 21.91, "/LO_NET"))
new_elements.extend(path([
    (46.5, 21.91), (36.0, 21.91), (36.0, 24.5)
], "/LO_NET", "B.Cu"))
new_elements.append(via(36.0, 24.5, "/LO_NET"))
new_elements.extend(path([
    (36.0, 24.5), (36.0, 25.0), (33.92, 25.0)
], "/LO_NET"))
...
# Route power traces from Q1-3 going left to x=59.0 to avoid L1-1
new_elements.extend(path([
    (60.54, 15.0), (59.0, 15.0), (59.0, 18.0), (67.54, 18.0)
], "/MID", width=1.5))
# Narrow entry to L1 pin 2
new_elements.extend(path([
    (67.54, 18.0), (67.54, 16.5)
], "/MID"))
new_elements.extend(path([
    (67.54, 16.5), (67.54, 15.0)
], "/MID", width=1.5))
# Connect Q2 pin 2 with narrowed entry
new_elements.extend(path([
    (59.0, 18.0), (58.0, 18.0), (58.0, 22.0)
], "/MID"))
new_elements.extend(path([
    (58.0, 22.0), (58.0, 25.0)
], "/MID", width=1.5))
# Sense lines (0.5mm, routed on B.Cu and F.Cu via, via shifted to y=21.0 to avoid VCC short)
new_elements.append(via(58.0, 21.0, "/MID"))
new_elements.extend(path([
    (58.0, 20.0), (58.0, 21.0)
], "/MID", width=0.5))
new_elements.append(via(44.5, 21.0, "/MID"))
new_elements.append(via(31.6, 13.0, "/MID"))
new_elements.extend(path([
    (58.0, 21.0), (44.5, 21.0), (31.6, 21.0), (31.6, 13.0)
], "/MID", "B.Cu", width=0.5))
new_elements.extend(path([
    (44.5, 21.0), (44.5, 20.64), (41.91, 20.64)
], "/MID", width=0.5))
new_elements.extend(path([
    (31.6, 13.0), (31.6, 15.0)
], "/MID", width=0.5))
...
# 12. /RF_OUT: L2-1 -> C6-1 -> J2-1 (via B.Cu to avoid crossing /TANK_OUT, narrowed entry at L2 pin 1)
new_elements.extend(path([
...
print("=== PCB ROUTING RE-BUILT (V7) SUCCESSFULLY ===")
