...
new_elements.extend(path([
    (2.46, 5.0), (2.46, 2.2), (15.5, 2.2), (15.5, 5.0)
], "+72V5"))
new_elements.extend(path([
...
# Branch on B.Cu to U1-3 (38.09, 20.64) via a via at (35.0, 20.64), routed at y=19.0 on B.Cu to clear MID B.Cu
new_elements.extend(path([
    (24.92, 19.0), (35.0, 19.0), (35.0, 20.64)
], "VCC", "B.Cu"))
...
# 6. /HO_NET: U1-7 -> D2-1 -> R1-2 (routed entirely on F.Cu at y=17.0 to avoid VCC B.Cu crossing)
new_elements.extend(path([
    (41.91, 19.36), (41.91, 17.0), (33.92, 17.0), (33.92, 15.0)
], "/HO_NET"))
new_elements.extend(path([
    (41.91, 17.0), (48.0, 17.0), (48.0, 16.6)
], "/HO_NET"))

# 7. /LO_NET: U1-5 -> D3-1 -> R2-2 (routed entirely on F.Cu at y=23.0 to avoid VCC B.Cu crossing)
new_elements.extend(path([
...
# Route power traces straight down to y=18.0 with narrowed entries to clear L1-1
new_elements.extend(path([
    (60.54, 15.0), (60.54, 18.0), (67.54, 18.0)
], "/MID", width=1.5))
...
new_elements.extend(path([
    (60.54, 18.0), (58.0, 18.0), (58.0, 22.0)
], "/MID"))
new_elements.extend(path([
    (58.0, 22.0), (58.0, 25.0)
], "/MID", width=1.5))
...
# 12. /RF_OUT: L2-1 -> C6-1 -> J2-1 (via B.Cu to avoid crossing /TANK_OUT, narrowed entry at L2 pin 1, shifted right to avoid J2-2 GND short)
new_elements.extend(path([
...
print("=== PCB ROUTING RE-BUILT (V8) SUCCESSFULLY ===")
