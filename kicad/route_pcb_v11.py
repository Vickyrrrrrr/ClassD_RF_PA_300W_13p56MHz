...
try:
    with open('/mnt/c/Users/VICKY/.gemini/antigravity/brain/68b9da98-936f-466c-a057-5068ba514e02/task.md', 'r') as tf:
        t_content = tf.read()
    t_content = t_content.replace("- [/] Run KiCad DRC check and refill zones", "- [x] Run KiCad DRC check and refill zones")
    t_content = t_content.replace("- [ ] Verify that routing violations are fully resolved", "- [/] Verify that routing violations are fully resolved")
...
new_elements.extend(path([
    (35.08, 11.0), (35.08, 18.09), (38.09, 18.09)
], "VB"))
...
# 5. /LIN: J4-2 -> U1-8 (via F.Cu to x=28.0, then B.Cu running at y=12.0 to clear HO_NET B.Cu)
new_elements.extend(path([
    (5.0, 27.54), (28.0, 27.54)
], "/LIN"))
new_elements.append(via(28.0, 27.54, "/LIN"))
new_elements.extend(path([
    (28.0, 27.54), (28.0, 12.0), (44.5, 12.0), (44.5, 18.09)
], "/LIN", "B.Cu"))
...
# 8. /GATE1: R1-1 -> D2-2 -> Q1-1 (routed on F.Cu going up to y=12.0 to clear HO_NET F.Cu)
new_elements.extend(path([
    (48.0, 16.6), (48.0, 12.0), (44.08, 12.0), (44.08, 15.0)
], "/GATE1"))
new_elements.extend(path([
...
# Route power traces straight UP to y=10.0 to clear L1-1 (at 62.46, 15.0)
new_elements.extend(path([
...
# 11. /TANK_OUT: L1-1 -> C5-1 -> R3-1 -> L2-2 (narrowed entry at L1 pin 1 to 1.5mm to clear MID)
new_elements.extend(path([
    (62.46, 15.0), (62.46, 16.5)
], "/TANK_OUT", width=1.5))
new_elements.extend(path([
    (62.46, 16.5), (63.4, 22.0), (62.46, 30.0)
], "/TANK_OUT"))
...
# C6 pin 2 (73.6, 22.0) - shift via to (68.0, 26.0) to clear TANK_OUT and RF_OUT
new_elements.append(via(68.0, 26.0, "GND"))
new_elements.extend(path([(73.6, 22.0), (73.6, 26.0), (68.0, 26.0)], "GND"))
...
print("=== PCB ROUTING RE-BUILT (V11) SUCCESSFULLY ===")
