...
# 5. /LIN: J4-2 -> U1-8 (via F.Cu crossing, then jump to B.Cu at x=28.0)
new_elements.extend(path([
    (5.0, 27.54), (28.0, 27.54)
], "/LIN"))
new_elements.append(via(28.0, 27.54, "/LIN"))
new_elements.extend(path([
    (28.0, 27.54), (45.0, 27.54), (45.0, 18.09), (44.5, 18.09)
], "/LIN", "B.Cu"))
...
# 6. /HO_NET: U1-7 -> D2-1 -> R1-2 (via B.Cu, jumping back to F.Cu at x=36.0 to avoid VCC crossing)
new_elements.extend(path([
    (41.91, 19.36), (46.5, 19.36), (46.5, 16.6), (48.0, 16.6)
], "/HO_NET"))
new_elements.append(via(46.5, 19.36, "/HO_NET"))
new_elements.extend(path([
    (46.5, 19.36), (36.0, 19.36)
], "/HO_NET", "B.Cu"))
new_elements.append(via(36.0, 19.36, "/HO_NET"))
new_elements.extend(path([
    (36.0, 19.36), (36.0, 15.0), (33.92, 15.0)
], "/HO_NET"))

# 7. /LO_NET: U1-5 -> D3-1 -> R2-2 (via B.Cu, jumping back to F.Cu at x=36.0 to avoid VCC crossing)
new_elements.extend(path([
    (41.91, 21.91), (46.5, 21.91), (46.5, 26.6), (48.0, 26.6)
], "/LO_NET"))
new_elements.append(via(46.5, 21.91, "/LO_NET"))
new_elements.extend(path([
    (46.5, 21.91), (36.0, 21.91)
], "/LO_NET", "B.Cu"))
new_elements.append(via(36.0, 21.91, "/LO_NET"))
new_elements.extend(path([
    (36.0, 21.91), (36.0, 25.0), (33.92, 25.0)
], "/LO_NET"))
...
# Route power traces around L1 pin 1 (62.46, 15.0) with narrowed entry to Q1 pin 3
new_elements.extend(path([
    (60.54, 15.0), (60.54, 17.0)
], "/MID", width=1.5))
new_elements.extend(path([
    (60.54, 17.0), (60.54, 18.0), (67.54, 18.0)
], "/MID"))
...
# Sense lines (0.5mm, routed on B.Cu and F.Cu via)
...
print("=== PCB ROUTING RE-BUILT (V6) SUCCESSFULLY ===")
